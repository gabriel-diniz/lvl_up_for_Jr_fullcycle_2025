...
app.post('/partners/register', async (req, res) => {
    ...
    res
        .status(201)
        .json({id: partnerResult.insertId, name, user_id: userId, company_name, created_at: createdAt})
    }finally {
        await connection.end();
    }
});
...
app.post('/customers/register', async (req,res) =>{
    ...
    res
        .status(201)
        .json({id: partnerResult.insertId, name, user_id: userId, address, phone, created_at: createdAt})
    }finally {
        await connection.end();
    }
});
...
app.get('/events/:eventId', async (req, res) => {
    ...
    try{
        ...
        await connection.end();//REST - Representaçã do estado
    }   
});
